...
<BODY>
	<form name="frm_mod_goods" method=post>
			...
			<DIV class="tab_container">
				<DIV class="tab_content" id="tab1">
					<table>
						...
						<tr>
							<td>저자</td>
							<td><input name="goods_writer" type="text" size="40"
								value="${goods.goods_writer }" /></td>
							<td><input type="button" value="수정반영"
						...
						<tr>
							...
							<td><input name="goods_publisher" type="text" size="40"
								value="${goods.goods_publisher }" /></td>
							<td><input type="button" value="수정반영"
						...
						<tr>
							<td>제품출판일</td>
							<td><input name="goods_published_date" type="text" size="40"
								value="${goods.goods_published_date }" /></td>
							<td><input type="button" value="수정반영"
						...
						<tr>
							<td>제품 총 페이지수</td>
							<td><input name="goods_total_page" type="text" size="40"
								value="${goods.goods_total_page }" /></td>
							<td><input type="button" value="수정반영"
						...
						<tr>
							<td>ISBN</td>
							<td><input name="goods_isbn" type="text" size="40"
								value="${goods.goods_isbn }" /></td>
							<td><input type="button" value="수정반영"
						...
						<tr>
							<td>제품 도착 예정일</td>
							<td><input name="goods_delivery_date" type="text" size="40"
						...
						<tr>
							...
							</select> <input type="hidden" name="h_goods_type"
								value="${goods.goods_type }" /></td>
							<td><input type="button" value="수정반영"
								onClick="fn_modify_goods('${goods.goods_id }','goods_type')" />
							</td>
						</tr>
						<tr>
							<td colspan=3><br></td>
					...
					<table>
						<tr>
							...
							<td><textarea rows="100" cols="80"
									name="goods_contents_order">
					  ${goods.goods_contents_order }
					</textarea></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="button"
								value="수정반영"
								onClick="fn_modify_goods('${goods.goods_id }','goods_contents_order')" />
							</td>
						</tr>
					</table>
				</DIV>
					...
					<table>
						<tr>
						  ...
						  ${goods.goods_writer_intro }
							...
							<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="button"
								value="수정반영"
								onClick="fn_modify_goods('${goods.goods_id }','goods_writer_intro')" />
							</td>
						</tr>
					</table>
					</P>
				...
				<DIV class="tab_content" id="tab5">
					...
					<table>
						<tr>
							<td>출판사 제품 평가</td>
							<td><textarea rows="100" cols="80"
									name="goods_publisher_comment">
						  ${goods.goods_publisher_comment }
						</textarea></td>
							<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="button"
								value="수정반영"
								onClick="fn_modify_goods('${goods.goods_id }','goods_publisher_comment')" />
							</td>
						</tr>
					</table>
					</P>
					...
					<table>
						<tr>
						  ...
						  ${goods.goods_recommendation }
							...
							<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="button"
								value="수정반영"
								onClick="fn_modify_goods('${goods.goods_id }','goods_recommendation')" />
							</td>
						</tr>
					</table>
					</p>
		...
		<table>
			<tr>
				<td align=center colspan=2><INPUT type="button" value="이미지수정하기"
					onClick="fn_moveToImagePage('${goods.goods_id }')"></td>
			</tr>
		</table>
	</form>