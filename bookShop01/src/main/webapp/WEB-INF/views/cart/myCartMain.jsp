...
<body>
				...
				<c:otherwise>
					<tr>
						<form name="frm_order_all_cart">
							<c:forEach var="item" items="${cartHash.my_goods_list }"
								varStatus="cnt">
								<c:set var="cart_goods_qty"
									value="${cartHash.my_cart_list[cnt.count-1].cart_goods_qty}" />
								<c:set var="cart_id"
									value="${cartHash.my_cart_list[cnt.count-1].cart_id}" />
								<td><input type="checkbox" name="select_goods" checked
									value="${item.goods_id }"
								...
								<td><input type="text" id="cart_goods_qty"
									...
									href="javascript:modify_cart_qty(${item.goods_id },${item.goods_sales_price*0.9 },${cnt.count-1 });">
										<img width=25 alt=""
										src="${pageContext.request.contextPath}/resources/image/btn_modify_qty.jpg">
								</a></td>
								<td><strong> <fmt:formatNumber
								...
								<td><a
									href="javascript:fn_order_each_goods('${item.goods_id }','${item.goods_title }','${item.goods_sales_price}','${item.goods_fileName}');">
										<img width="75" alt=""
										src="${pageContext.request.contextPath}/resources/image/btn_order.jpg">
	...
	<table width=80% class="list_view" style="background: #cacaff">
		<tbody>
			...
			<tr cellpadding=40 align=center>
				...
				<td><img width="25" alt=""
					src="${pageContext.request.contextPath}/resources/image/minus.jpg">
				</td>
				<td>
				...
				<td><img width="25" alt=""
					src="${pageContext.request.contextPath}/resources/image/equal.jpg">
				</td>
				<td>
	...
	<center>
		...
		<br> <a href="javascript:fn_order_all_cart_goods()"> <img
			width="75" alt=""
			src="${pageContext.request.contextPath}/resources/image/btn_order_final.jpg">
		</a> <a href="#"> <img width="75" alt=""
			src="${pageContext.request.contextPath}/resources/image/btn_shoping_continue.jpg">
		</a>
		<center>
			</form>