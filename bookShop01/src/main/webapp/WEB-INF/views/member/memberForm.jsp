...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/jquery/jquery-1.6.2.min.js"></script>
<script>
    ...
    function fn_overlapped(){
    	var tUserId = document.getElementById("userId");
    	var _id = tUserId.value;

    	
    		$.ajax({
    			type:"post",
    			async:false,  //false인 경우 동기식으로 처리한다.
    			url:"http://localhost:8091/bookshop01/member/idOverlapped.do",
    			dataType:"text",
    			data:{id:_id},
		...
		<TABLE>
			<TBODY>
				<TR class="dot_line">
					...
					<TD><input name="member_id" type="text" size="20" id="userId"/>
					<input type="button" value="중복 조회" onclick="fn_overlapped()" />
					</TD>
				</TR>
				<TR class="dot_line">
